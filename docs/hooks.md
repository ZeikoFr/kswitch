...
You can find several demo configuration files [here](https://github.com/MichaelSp/kswitch/tree/master/resources/demo-config-files).
...
The Hook [`gardener-landscape-sync`](https://github.com/MichaelSp/kswitch/tree/master/hooks/gardener-landscape-sync) downloads the 
...
hooks:
  - name: sync-dev-landscape
    type: Executable
    path: /Users/<your-user>/go/src/github.com/MichaelSp/kswitch/hack/hooks/hook-gardener-landscape-sync
    arguments:
      - "sync"
